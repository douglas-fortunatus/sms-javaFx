 ...
 * @author Douglas
 */
public class ViewExam implements ViewMaker{

    private Stage stage;
    
    public ViewExam(Stage stage) {
        this.stage = stage;
    }
    ...
    public Scene getScene() {
        ...
        GridPane resultdisplay = new GridPane();
        Text stResult = new Text("Result");
        
        Label semChoice = new Label("Choose Semester");
//        Label stResult = new Label("f");
//        Label stResult = new Label("f");
//        Label stResult = new Label("f");
//        Label stResult = new Label("f");
