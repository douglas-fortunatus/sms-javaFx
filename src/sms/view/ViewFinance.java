 ...
 * @author Douglas
 */
public class ViewFinance implements ViewMaker{

    private Stage stage;

    public ViewFinance(Stage stage) {
        this.stage = stage;
    }
    ...
    public Scene getScene() {
        ...
        Button attendanceSection = new Button("Finance");
        attendanceSection.setId("sideBtnA");
